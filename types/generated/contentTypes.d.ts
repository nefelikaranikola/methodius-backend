...
export interface ApiContractContract extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    grossSalary: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Employment Contract'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dateOfJoining: Schema.Attribute.Date & Schema.Attribute.Required;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<
      ['Meeting', 'Deadline', 'Holiday', 'Other']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Meeting'>;
...
export interface ApiLeaveRequestLeaveRequest
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Sick Leave'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::leave-request.leave-request'
